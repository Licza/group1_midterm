...
### Instructions
To render the entire report, simply clone the repository in your desired directory
and enter "make"" into the terminal. If you want to subset the data by sex or
by medical unit type, provide the command "make SEX=<"male" "female" or "all">
